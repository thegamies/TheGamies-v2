    ...
    <div className="mt-6 max-w-xl space-y-8">
      {joinsClosed ? (
        <p className="text-sm text-muted">
          This community isn’t taking new members. Invite links will not work
          until that changes.
        </p>
      ) : (
        <>
          <p className="text-sm text-muted">
            People join this community with an invite link. Generating a new
            code retires the current one.
          </p>
          ...
          <form action={openAction} className="space-y-4">
            ...
            <p className="text-sm text-ink">
              Open invites are {openInvites ? "on" : "off"}. Admins can always
              copy the invite from the header. When open invites are on,
              members can too.
            </p>
