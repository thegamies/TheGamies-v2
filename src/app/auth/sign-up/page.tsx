...
function SignUpForm() {
  ...
  const oauthError = googleOAuthReturnMessage(searchParams.get("error"));
  ...
  return (
    <>
      ...
      <div className="mt-10 space-y-4">
        <ContinueWithGoogle errorCallbackPath="/auth/sign-up" />
        {oauthError ? (
          <p className="text-sm text-accent">{oauthError}</p>
        ) : null}
