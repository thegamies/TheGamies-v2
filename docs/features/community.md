...
- `/communities/[slug]/the-game-awards` → opted-in year; `/communities/[slug]/the-game-awards/[year]` — Pick’em (members: Your ballot default; closed-join guests: Standings)
