...
- Hold briefly to reorder (no persistent move handle). Poster/Grid: tap a game to select and reveal delete; tap elsewhere to dismiss. List keeps always-visible remove.
