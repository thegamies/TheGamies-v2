...
| 2026-08-16 | List card interaction | No always-visible move/remove buttons. **Hold** (~280ms) to drag-reorder; suppress mobile callout. **Tap** selects a card and shows inset delete; tap elsewhere dismisses. |
