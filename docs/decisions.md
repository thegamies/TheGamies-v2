...
| 2026-08-14 | Edition rank mode | **Host setting** on the event (`community_editions.rank_mode`), default **competition** (1–1–3). **Dense** (1–1–2) is the other option. Hosts may change it anytime — displayed rank is derived at read, not stored. Not a public `?rank=` chooser. Site and community live stay competition only. GOTY Comparison follows that setting (no Board / span picker). |
