...
| 2026-08-16 | List card interaction | Poster and Grid: no always-visible move/remove buttons; **hold** (~280ms) to drag-reorder; suppress mobile callout; **tap** selects and shows inset delete (tap elsewhere dismisses). **List** format keeps always-visible remove; hold-to-reorder only. |
